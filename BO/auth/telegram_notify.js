...
const TelegramAll = new TelegramBot('5316995678:AAECNwQ6BLFaeeJU4PrlAFee7wwblLlNqu4', {polling: true})
...
module.exports = {
    ...
    sendBC: (content = '') => {
        ...
        TelegramAll.sendMessage(`@actbecau888`, content, {parse_mode : "HTML"})
    }
}